...
const Player = ({setOpenState}) => {
  ...
  const gesture = Gesture.Pan()
    .onUpdate(e => {
      translateY.value = `${clamp((e.translationY / height) * 100, 0, 100)}%`;
    })
    .onEnd(() => {
    ...
    <GestureDetector gesture={gesture}>
      <Animated.View
        ...
        <View style={styles.contentContainer}>
          ...
          <Text
            style={[styles.time, {color: isDarkMode ? 'white' : '#7150D0'}]}>
          ...
          <View style={styles.controlsContainer}>
            ...
            <TouchableOpacity
              ...
              {isRepeat &&
                Icons.MaterialCommunityIcons.repeatOnce(26, '#8572B8')}
            </TouchableOpacity>
          </View>
        </View>
